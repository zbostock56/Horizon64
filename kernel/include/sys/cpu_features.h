 ...
 * @file cpu_features.h
 * @author Zack Bostock
 * @brief Information on specific CPU features
 *
...
/*
  These are defined from the OSDev wiki: https://wiki.osdev.org/CPUID

  They define specific bitstrings that can be used to determine CPU feature
  sets.
*/
...
/*
  Here are CPU vendor defines for determining the CPU vendor using the cpuid
  command with 0x0 inputted in the "feature" parameter (which goes into eax).
*/
...
static const CPUID_FEATURE cpuid_feature_apic = {
    .feature = 0x00000001,
    .registers = CPUID_EDX,
