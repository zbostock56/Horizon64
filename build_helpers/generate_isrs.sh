...
echo "" >> $ISRS_GEN_C
echo "void i686_isr_init_gates() {" >> $ISRS_GEN_C

for i in $(seq 0 255); do
    echo "    i686_idt_set_gate(${i}, i686_ISR${i}, i686_GDT_CODE_SEGMENT_RING0, IDT_FLAG_RING0 | IDT_FLAG_GATE_32BIT_INT);" >> $ISRS_GEN_C
done
